namespace MVC_Blog.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        //        CreateUser(context, "fenderspoon@abv.bg", "123", "System Administrator");
        //        CreateUser(context, "pesho@abv.bg", "123", "Peter Ivanov");
        //        CreateUser(context, "merry@abv.bg", "123", "Maria Petrova");
        //        CreateUser(context, "geshu@abv.bg", "123", "George Petrov");

        //        CreateRole(context, "Administrators");
        //        AddUserToRole(context, "fenderspoon@abv.bg", "Administrators");
